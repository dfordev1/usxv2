...
const batch29 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-029-decisions.json"), "utf8"));
const batch30 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-030-decisions.json"), "utf8"));
const batch31 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-031-decisions.json"), "utf8"));
const batch32 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-032-decisions.json"), "utf8"));
const batch33 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-033-decisions.json"), "utf8"));
const batch34 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-034-decisions.json"), "utf8"));
const batch35 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-035-decisions.json"), "utf8"));
const batch36 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-036-decisions.json"), "utf8"));
const batch37 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-037-decisions.json"), "utf8"));
const batch38 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-038-decisions.json"), "utf8"));
const batch39 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-039-decisions.json"), "utf8"));
const batch40 = JSON.parse(await readFile(path.join(root, "data/review/printed-review-batch-040-decisions.json"), "utf8"));
...
for (const record of batch29.records) manual.set(record.id, record);
for (const record of batch30.records) manual.set(record.id, record);
for (const record of batch31.records) manual.set(record.id, record);
for (const record of batch32.records) manual.set(record.id, record);
for (const record of batch33.records) manual.set(record.id, record);
for (const record of batch34.records) manual.set(record.id, record);
for (const record of batch35.records) manual.set(record.id, record);
for (const record of batch36.records) manual.set(record.id, record);
for (const record of batch37.records) manual.set(record.id, record);
for (const record of batch38.records) manual.set(record.id, record);
for (const record of batch39.records) manual.set(record.id, record);
for (const record of batch40.records) manual.set(record.id, record);
